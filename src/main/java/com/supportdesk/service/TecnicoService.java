...
public class TecnicoService {
    ...
    private TecnicoResponseDTO converterParaResponseDTO(
            Tecnico tecnico) {
        ...
        return new TecnicoResponseDTO(
                ...
                tecnico.getNome(),
                tecnico.getEmail(),
                tecnico.getEmpresa().getId()
        );
    }

    public TecnicoResponseDTO salvar(
            CriarTecnicoDTO dto,
            Long empresaId) {
    ...
    public List<TecnicoResponseDTO> listarTodos(
        ...
        return tecnicoRepository.findByEmpresaId(empresaId)
                .stream()
                .map(this::converterParaResponseDTO)
                .toList();
    }

    public TecnicoResponseDTO buscarPorId(
            Long id,
            Long empresaId) {
    ...
    public TecnicoResponseDTO atualizar(
            Long id,
            AtualizarTecnicoDTO dto,
            Long empresaId) {
